...
const HERO_IMAGE = 'https://images.pexels.com/photos/18936639/pexels-photo-18936639.jpeg?auto=compress&cs=tinysrgb&w=1600'
          ...
          {gridSlices.map((slice, index) => {
            ...
            return (
              <div
                ...
                style={{
                  flexBasis: `${flexBasis}%`,
                  flexGrow: isHovered ? 2 : isOtherHovered ? 0.3 : 1,
                  flexShrink: 1,
                }}
